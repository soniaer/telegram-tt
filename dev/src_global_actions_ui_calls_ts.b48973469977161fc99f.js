...
(0,_index__WEBPACK_IMPORTED_MODULE_15__.addActionHandler)('openTelegramLink', async (global, actions, payload) => {
  ...
  if (params.hasOwnProperty('voicechat') || params.hasOwnProperty('livestream')) {
    ...
    focusMessage({
      chatId: (0,_helpers__WEBPACK_IMPORTED_MODULE_14__.toChannelId)(chatOrChannelPostId),
      messageId,
      tabId
    });
...
(0,_index__WEBPACK_IMPORTED_MODULE_15__.addActionHandler)('processBoostParameters', async (global, actions, payload) => {
  ...
  let chat;
  if (isPrivate) {
    const chatId = (0,_helpers__WEBPACK_IMPORTED_MODULE_14__.toChannelId)(usernameOrId);
    chat = (0,_selectors__WEBPACK_IMPORTED_MODULE_19__.selectChat)(global, chatId);
    if (!chat) {
      actions.showNotification({
...
(0,_index__WEBPACK_IMPORTED_MODULE_15__.addActionHandler)('joinChatlistInvite', async (global, actions, payload) => {
  ...
  const folder = 'folderId' in invite ? (0,_selectors__WEBPACK_IMPORTED_MODULE_19__.selectChatFolder)(global, invite.folderId) : undefined;
  ...
  try {
    ...
    if (!result) return;
    actions.showNotification({
      title: _util_oldLangProvider__WEBPACK_IMPORTED_MODULE_10__.oldTranslate(folder ? 'FolderLinkUpdatedTitle' : 'FolderLinkAddedTitle', folderTitle),
      message: _util_oldLangProvider__WEBPACK_IMPORTED_MODULE_10__.oldTranslate('FolderLinkAddedSubtitle', notJoinedCount, 'i'),
      tabId
    });
  } catch (error) {
...
(0,_index__WEBPACK_IMPORTED_MODULE_15__.addActionHandler)('leaveChatlist', async (global, actions, payload) => {
  ...
  if (!result) return;
  actions.showNotification({
    title: _util_oldLangProvider__WEBPACK_IMPORTED_MODULE_10__.oldTranslate('FolderLinkDeletedTitle', folder.title),
    message: _util_oldLangProvider__WEBPACK_IMPORTED_MODULE_10__.oldTranslate('FolderLinkDeletedSubtitle', peers.length, 'i'),
    tabId
  });
});
...
//# sourceMappingURL=src_global_actions_ui_calls_ts.b48973469977161fc99f.js.map